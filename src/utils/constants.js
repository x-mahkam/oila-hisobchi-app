...
export const ONB_SLIDES = [
  ...
  {id:"reports", color:"ac",
   titleUz:"Aqlli hisobotlar", titleRu:"Умные отчёты", titleEn:"Smart reports",
   descUz:"Grafiklar, moliyaviy sog'liq va AI tavsiyalar — qarorlar osonlashadi.",
   descRu:"Графики, финансовое здоровье и AI-советы — решения проще.",
   descEn:"Charts, financial health and AI insights — decisions made easy."},
  {id:"premium", color:"gold",
   titleUz:"Premium bilan cheksiz", titleRu:"Безгранично с Premium", titleEn:"Unlimited with Premium",
   descUz:"Cheksiz maqsad, PDF/Excel eksport va AI tavsiyalar.",
   descRu:"Безлимитные цели, экспорт PDF/Excel и AI-советы.",
   descEn:"Unlimited goals, PDF/Excel export and AI insights."},
];
