...
export const ONB_SLIDES = [
  ...
  {id:"reports", color:"ac",
   ...
   descUz:"Grafiklar, moliyaviy sog'liq va foydali tavsiyalar — qarorlar osonlashadi.",
   descRu:"Графики, финансовое здоровье и полезные советы — решения проще.",
   descEn:"Charts, financial health and useful insights — decisions made easy."},
