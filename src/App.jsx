  ...
  if(scr==="login")return <div style={S.pg}>
    ...
    <div style={{padding:"50px 24px 40px",position:"relative"}}>
      ...
      <div style={S.cd}>
        ...
        {!kidLoginMode&&<button onClick={doGoogleLogin} disabled={ld} style={{width:"100%",padding:"13px 16px",borderRadius:14,border:"1.5px solid "+th.bor,background:th.surH,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:12}}>
