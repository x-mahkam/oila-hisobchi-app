...
const T = {
  ...
  kk: {
    title: "Аватар дүкені",
    subtitle: "Жаңа аватар сатып алып, профиліңізді безендіріңіз!",
    coinsBalance: "Менің тиындарым",
    free: "Тегін",
    buy: "Сатып алу",
    unlocked: "Құлыптан босатылған",
    active: "Белсенді",
    select: "Таңдау",
    insufficientCoins: "Кешіріңіз, сізде тиындар жеткіліксіз! Тағы {amount} тиын жинауыңыз керек.",
    errorTitle: "Тиындар жеткіліксіз",
    confirmTitle: "Сатып алуды растау",
    confirmMsg: "Сіз бұл аватарды {price} тиынға сатып алғыңыз келеді.",
    activeGoalWarning: "⚠️ Ескерту: Белсенді мақсатыңыз бар: '{goalTitle}'.",
    consciousSpendMsg: "Бұл аватарды сатып алу мақсатыңызға жетуді баяулатады, өйткені сіз жинақтағы {price} тиынды жұмсайсыз.",
    wantsVsNeeds: "Бұл сатып алу сіз үшін қазір шынымен қажеттілік пе әлде жай ғана қалау ма? Ойланып көріңіз!",
    yesBuy: "Иә, сатып аламын",
    noCancel: "Жоқ, бас тарту",
    successBuy: "Жаңа аватар сәтті сатып алынды және орнатылды! 🎉",
    successSelect: "Аватар сәтті ауыстырылды! ✓",
  },
  ky: {
    title: "Аватар дүкөнү",
    subtitle: "Жаңы аватар сатып алып, профилиңизди кооздоңуз!",
    coinsBalance: "Менин тыйындарым",
    free: "Акысыз",
    buy: "Сатып алуу",
    unlocked: "Кулпусу ачылган",
    active: "Активдүү",
    select: "Тандоо",
    insufficientCoins: "Кечиресиз, сизде тыйындар жетишсиз! Дагы {amount} тыйын топтошуңуз керек.",
    errorTitle: "Тыйындар жетишсиз",
    confirmTitle: "Сатып алууну ырастоо",
    confirmMsg: "Сиз бул аватарды {price} тыйынга сатып алгыңыз келет.",
    activeGoalWarning: "⚠️ Эскертүү: Сизде активдүү максат бар: '{goalTitle}'.",
    consciousSpendMsg: "Бул аватарды сатып алуу максатыңызга жетүүнү баяулатат, анткени сиз топтолгон {price} тыйынды жұмшайсыз.",
    wantsVsNeeds: "Бул сатып алуу сиз үчүн азыр чынында эле муктаждыкпы же жөн гана каалообу? Ойлонуп көрүңүз!",
    yesBuy: "Ооба, сатып алам",
    noCancel: "Жок, жокко чыгаруу",
    successBuy: "Жаңы аватар ийгиликтүү сатып алынды жана орнотулду! 🎉",
    successSelect: "Аватар ийгиликтүү алмаштырылды! ✓",
  },
  tg: {
    title: "Дӯкони аватарҳо",
    subtitle: "Аватари нав харед ва профили худро оро диҳед!",
    coinsBalance: "Тангаҳои ман",
    free: "Ройгон",
    buy: "Харидан",
    unlocked: "Кушода",
    active: "Фаъол",
    select: "Интихоб кардан",
    insufficientCoins: "Бубахшед, шумо тангаи кофӣ надоред! Бояд боз {amount} танга ҷамъ кунед.",
    errorTitle: "Тангаҳо нокофӣ",
    confirmTitle: "Тасдиқи харид",
    confirmMsg: "Шумо мехоҳед ин аватарро ба ивази {price} танга харед.",
    activeGoalWarning: "⚠️ Огоҳӣ: Шумо ҳадафи фаъол доред: '{goalTitle}'.",
    consciousSpendMsg: "Харидани ин аватар расидан ба ҳадафи шуморо ба таъхир меандозад, зеро шумо аз пасандозҳои худ {price} танга сарф мекунед.",
    wantsVsNeeds: "Оё ин харид ҳоло барои шумо воқеан ниёзи зарурӣ аст ё танҳо як ҳавас? Андеша кунед!",
    yesBuy: "Бале, мехарам",
    noCancel: "Не, бекор кардан",
    successBuy: "Аватари нав бомуваффақият харида ва насб карда шуд! 🎉",
    successSelect: "Аватар бомуваффақият иваз карда шуд! ✓",
  },
  qr: {
    title: "Avatar du'kani",
    subtitle: "Jan'a avatar satip alin' ha'm profilin'izdi bezetin'!",
    coinsBalance: "Menin' tangalarim",
    free: "Biypul",
    buy: "Satip alis",
    unlocked: "Ashiqliq",
    active: "Amaldag'i",
    select: "Tan'law",
    insufficientCoins: "Keshirin', sizde jetkilikli coin joq! Ja'ne {amount} coin jıynawın'ız kerek.",
    errorTitle: "Coin jetkilikli emes",
    confirmTitle: "Satip alisti tastiyqlaw",
    confirmMsg: "Siz usı avatardı {price} coin ornına satip almaqshisiz.",
    activeGoalWarning: "⚠️ Eskertiw: Sizde belsendi maqset bar: '{goalTitle}'.",
    consciousSpendMsg: "Usı avatardı satip alis maqsetin'izge jetiwin'izdi ba'sentletedi, o'ytkeni siz jın'arg'anların'izdan {price} coin kiritessiz.",
    wantsVsNeeds: "Usı satıp alıw siz ushın ha'azir haqıyqattan da' kerekpe yamasa tek g'ana qa'lep tursızba? Oylap ko'rin'!",
    yesBuy: "Awa, satipalaman",
    noCancel: "Yaq, biykar etiw",
    successBuy: "Jan'a avatar tabisli satip alindi ha'm ornatildi! 🎉",
    successSelect: "Avatar tabisli almastirildi! ✓",
  }
};
