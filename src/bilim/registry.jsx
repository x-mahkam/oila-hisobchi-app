...
export const CATEGORIES = [
  ...
  { id: "nature",  name: { uz: "Tabiat", ru: "Природа", en: "Nature" },            icon: BIco.nature,  grad: ["gr", "am"] },
  { id: "tech",    name: { uz: "Texnologiya", ru: "Технологии", en: "Tech" },      icon: BIco.tech,    grad: ["ac", "rd"] },
  { id: "book",    name: { uz: "Kitob", ru: "Книга", en: "Book" },                 icon: BIco.book,    grad: ["am", "ac"] },
  { id: "other",   name: { uz: "Boshqalar", ru: "Другое", en: "Others" },          icon: BIco.other,   grad: ["ac2", "rd"] },
];
...
export const GAMES = [
  ...
  { id: "nature/biology",   category: "nature",name: { uz: "Biologiya", ru: "Биология", en: "Biology" },      desc: { uz: "Tabiat va tirik olam", ru: "Природа и жизнь", en: "Nature and life" },                   icon: BIco.nature, difficulty: "medium", minutes: 10, maxCoin: 15, premium: true },
  { id: "tech/scratch",     category: "tech",  name: { uz: "Scratch asoslari", ru: "Основы Scratch", en: "Scratch basics" }, desc: { uz: "Blokli dasturlashga kirish", ru: "Введение в блочное программирование", en: "Intro to block coding" }, icon: BIco.tech, difficulty: "hard", minutes: 15, maxCoin: 25, premium: true },
